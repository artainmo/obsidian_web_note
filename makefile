build: # Retrieve the note from obsidian 
	...
	[ -s obsidian-html/index.md ] || echo "<div class="content"><br>No active file or active file not found.</div>" > obsidian-html/index.md # Write an error message for non-existing files
	...
	awk '/<div class="content">/{flag=1} flag; /<\/div>/{if(flag){flag=0; exit}}' obsidian-html/output/html/index.html >> index.html \
		| sed '/<a class="inline-tag"/d; /<h1 id="index">index</h1>/d' > obsidian-html/index.html
