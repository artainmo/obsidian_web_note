...
#Internship II
sed -i '' 's/!\[\[Coursera 4V4FNOHS1GBM.pdf\]\]/<div class="pdf-container"><embed src="Coursera 4V4FNOHS1GBM.pdf" type="application\/pdf"><\/div>/g' index.md
sed -i '' 's/!\[\[Courrier fin stage Arthur Tainmont.pdf\]\]/<div class="pdf-container"><embed src="Courrier fin stage Arthur Tainmont.pdf" type="application\/pdf"><\/div>/g' index.md
